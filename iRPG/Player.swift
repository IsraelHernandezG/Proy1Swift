...
open class Player {
    ...
    init(posicion position: CGPoint, genero gen: String){
        ...
        items.append(["helmet","bronze_legion_2", "Yelmo de Soldado"])
        items.append(["helmet","bronze_legion_3", "Yelmo de Bronce"])
        items.append(["helmet","steel_legion_1", "Yelmo de Hierro"])
